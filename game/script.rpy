...
image kirby happy = ConditionSwitch(
    "_last_say_who=='kirby'", "kirby_happy.png",
    "not _last_say_who=='kirby'","kirby_happy_dark.png"
)
...
label after_load:
    if location == 0:
        play music "Cool Vibes.mp3" loop fadein 1.0 volume 1.5
    elif location == 1:
...
label clue_2photo:
    ...
    meowth sidepfp_inquisitive "{i}Who's this blue Ditto fella? I haven't seen him around town. No one must've introduced 'em to me.{/i}"
    jump investigate_2
...
label investigate_2i:
    ...
    menu:
        "Kirby":
            scene office
            show meowth happy at left, gray
            show kirby at right
            $ kirby2 = True
...
label climax:
    ...
    show meowth at gray with dissolve
